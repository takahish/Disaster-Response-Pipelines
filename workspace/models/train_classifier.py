...
def build_model():
    ...
    Returns:
        pipline: sklearn.pipeline.Pipeline. It contains a sklearn estimator.
    """
    pipeline = Pipeline([
...
def evaluate_model(model, X_test, Y_test, category_names):
    ...
    Args:
        model: sklearn.pipeline.Pipeline.  It contains a sklearn estimator.
...
def save_model(model, model_filepath):
    ...
    Args:
        model: sklearn.pipline.Pipeline. It contains a sklearn estimator.
